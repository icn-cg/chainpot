  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Decentralized privately funded money pools</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter a pool address to view details and participate</CardDescription>
          </CardHeader>
